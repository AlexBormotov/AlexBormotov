...
🔭 I’m currently working at Stellans - Since February 2024 I have participated in 7 projects:
   * a bank
...
`SQL`, `Python`, `Cursor`, `Claude Code`, `Airflow`, `DBT`, `Docker`, `GCP`, `Azure`, `AWS`, `Git`, `Bash`, `PySpark`, `Spark Streaming`, `Kafka`, `FastAPI`
...
| ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| DE   | [Mini-DWH with dbt, AirFlow, SCD2 and Dashboard on chart.js](https://github.com/AlexBormotov/dbt-project/blob/main/README.md) | End-to-end dbt project that demonstrates core dbt features (refs, vars, macros, incremental + SCD2) with a realistic ETL data flow. | `python`, `dbt`, `airflow`, `docker`, `mysql`, `postgresql`, `fastapi`, `chart.js` |
